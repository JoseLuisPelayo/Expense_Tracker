...
public class MockJsonManager implements IJsonManager{
    public <T> List<T> jsonDataToArrayList(File file, Class<T> myClass) {
        ...
        expenses.add(new Expense(1, "Expense test 1", 15.22, LocalDate.now(), Expense.Category.Others));
        expenses.add(new Expense(2, "Expense test 2", 25.99, LocalDate.now(), Expense.Category.Electronics));
